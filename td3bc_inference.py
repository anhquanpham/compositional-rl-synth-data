...
if __name__ == '__main__':
    ...
    # python td3bc_inference.py --checkpoint "/home/anhquanpham/projects/results/checkpoints/224_tasks/checkpoint_10000.pt" --device "cpu" --robot "Kinova3" --obj "Hollowbox" --obst "ObjectWall" --task "Shelf" --seed 0
    main()
